...
'Permite inserção de refeições extras apenas para administradores autenticados com permissões adequadas';
...
'Permite atualização de refeições extras apenas para administradores autenticados com permissões adequadas';