...
'Permite inserção de refeições extras para administradores com permissões específicas';
...
'Permite atualização de refeições extras para administradores com permissões específicas';