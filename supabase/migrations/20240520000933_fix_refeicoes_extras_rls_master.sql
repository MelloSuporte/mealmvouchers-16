...
-- Create insert policy that checks admin permissions and handles master admin
...
'Permite inserção de refeições extras para administradores com permissões específicas ou master admin';
...
'Permite atualização de refeições extras para administradores com permissões específicas ou master admin';