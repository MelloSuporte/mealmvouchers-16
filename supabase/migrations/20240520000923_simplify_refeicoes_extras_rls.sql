...
'Permite inserção de refeições extras apenas para administradores com permissão específica';

COMMENT ON POLICY "refeicoes_extras_select_policy" ON refeicoes_extras IS 
'Permite visualização de refeições extras apenas para administradores com permissão específica';

COMMENT ON POLICY "refeicoes_extras_update_policy" ON refeicoes_extras IS 
'Permite atualização de refeições extras apenas para administradores com permissão específica';