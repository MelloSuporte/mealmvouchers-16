...
'Permite inserção de refeições extras para administradores com permissões específicas ou usuários autenticados';
...
'Permite atualização de refeições extras para administradores com permissões específicas ou usuários autenticados';